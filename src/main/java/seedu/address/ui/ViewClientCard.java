 ...
 */
public class ViewClientCard extends UiPart<Region> {
    ...
    public ViewClientCard(Client client) {
        super(FXML);
        this.client = client;
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ViewClientCard)) {
            return false;
        }

        // state check
        ViewClientCard card = (ViewClientCard) other;
