...
public class AddExerciseCommand extends Command {
    ...
    public static final String MESSAGE_DUPLICATE_EXERCISE = "This exercise already exists in this client. Consider increment the sets of that existing exercise.";
