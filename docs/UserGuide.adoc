...
e.g. in `add n/NAME`, `NAME` is a parameter which can be used as `add-c n/John Doe`
...
Format: `add-c n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [g/GENDER] [h/HEIGHT] [cw/CURRENT_WEIGHT] [tw/TARGET_WEIGHT] [s/SPORT]… [t/TAG]…`
...
Format: `edit-c INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] [g/GENDER] [h/HEIGHT] [cw/CURRENT_WEIGHT] [tw/TARGET_WEIGHT] [s/SPORT]… [t/TAG]...`
