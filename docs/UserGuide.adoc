...
=== List all exercise templates: `list exercise templates`

Displays a list of exercise templates available in the program. Specify the muscle
group(s) to list only exercise templates that target that muscle group(s).

Format: `list exercise templates [m/MUSCLE]...`

Examples:

* `list exercise templates`
** Shows a list of all exercise templates and their information
* `list exercise templates m/abdomens m/chest`
** Shows all exercises that target the abdomens and chest

=== Add a new exercise template: `add exercise template`

If the list of predefined exercise templates are not enough, you may choose to add a new
exercise template for future use.
