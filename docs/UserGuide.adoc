...
+
** Adds an exercise called "Push Ups" with "50 reps" on 2nd July 2020 to the 1st client
* `view-c 3`
+
...
Assigns weekly schedule timings to a client. The schedule will be displayed on the right panel of FitBiz, with the timings as well as the client name. This command can assign multiple timings to a client at once, by adding more arguments following the command. 
