...
=== Storage of Client Exercise List
...
We have decided to store the exercises done by the client together with the same client in the JSON file. The `JsonAdaptedClient` will have a list of `JsonAdaptedExercise`.
