...
[discrete]
=== Use case 5: Tag client

*MSS*

1.  User requests to add tags to a client
2.  FitBiz shows a list of clients
3.  User requests to add a tag to a specific client in the list
4. FitBiz assigns the tag to the client
+
Use case ends.
...
[discrete]
=== Use case 7: Sort clients

*MSS*

1.  User requests to sort clients based on an attribute
2.  FitBiz sorts clients based on specified attribute
+
Use case ends.
...
[discrete]
=== Use case 8: Add exercise template

*MSS*

1.  User requests to add an exercise template.
2.  FitBiz adds the exercise template.
+
Use case ends.
...
[discrete]
=== Use case 9: Add routine template

*MSS*

1.  User requests to add an routine template.
2.  FitBiz adds the routine template.
+
Use case ends.
...
[discrete]
=== Use case 10: Edit routine template

*MSS*

1.  User requests to edit a routine template
2.  FitBiz shows a list of routine templates
3.  User requests to edit a specific routine template in the list and inputs the attributes and values
4.  FitBiz edits routine template
+
Use case ends.
