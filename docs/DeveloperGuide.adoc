...
|`* * *` |coach with many clients |be reminded of my daily schedule at the start of the day |I will not forget my appointments
...
|`* * *` |coach |delete my client |remove clients from my clients list

|`* * *` |coach |my client by typing their name |find my client’s information easily
...
|`* *` |coach with a tight schedule |opt to switch the app to a minimised view to present to me just the important data of the app, configurable by me
...
|`* *` |coach |track my clients’ macros |tell if my client is eating right with the right proportions
...
|`*` |coach |use the timer in the app |seamlessly execute the time interval of the workout planned
